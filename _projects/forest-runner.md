...
Forest Runner is a 3-lane 3D endless runner for mobile. We built it from scratch in three months, splitting systems across the team. I handled gameplay programming, level design, and game feel — everything except the login/registration UI.

The concepts here are fundamentals — nothing exotic — but working through them hands-on was the point.
...
I didn't know this pattern existed before this project. Finding it, understanding *why* it works, and implementing it was one of the more satisfying moments.
